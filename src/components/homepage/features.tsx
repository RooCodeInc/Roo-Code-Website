...
export const features: Feature[] = [
    ...
    },
    {
        ...
        description: "Roo Code reads your entire codebase, preserving valid code through diff-based edits for seamless multi-file refactors.",
        size: "small",
    },
    {
        icon: <FaTools className="h-6 w-6" />,
        title: "Open-Source and Model-Agnostic",
        description: "Bring your own model or use local AI—no vendor lock-in. Roo Code is free, open, and adaptable to your needs.",
        size: "large",
    },
    {
        icon: <FaTerminal className="h-6 w-6" />,
        title: "Guarded Command Execution",
        description: "Approve or deny commands as needed. Roo Code automates your dev workflow while keeping oversight firmly in your hands.",
        size: "small",
    },
    {
        icon: <FaPuzzlePiece className="h-6 w-6" />,
        title: "Fully Customizable",
        description: "Create or tweak modes, define usage rules, and shape Roo Code’s behavior precisely—your code, your way.",
        size: "small",
    },
    {
        icon: <FaGlobe className="h-6 w-6" />,
        title: "Automated Browser Actions",
        description: "Seamlessly test and verify your web app directly from VS Code—Roo Code can open a browser, run checks, and more.",
        size: "small",
    },
];
